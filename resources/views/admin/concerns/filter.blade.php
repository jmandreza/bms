    ...
    <x-slot name="content">
        ...
        <ul class="text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownRadioButton">
            <li class="hover:bg-gray-100">
                <x-input-label for="status-filter-replied" class="flex items-center px-4 py-2 gap-x-2">
                    <x-checkbox type="radio" id="status-filter-replied" name="status_filter" value="1" />
                    Replied
                </x-input-label>
            </li>
            <li class="hover:bg-gray-100">
                <x-input-label for="status-filter-not-replied" class="flex items-center px-4 py-2 gap-x-2">
                    <x-checkbox type="radio" id="status-filter-not-replied" name="status_filter" value="0" :checked="true" />
                    Not Replied
                </x-input-label>
            </li>
        </ul>
