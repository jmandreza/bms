<x-filter align="left">
    ...
    <x-slot name="content">
        ...
        <ul class="text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownRadioButton">
            ...
            <li class="hover:bg-gray-100">
                <x-input-label for="status-filter-{{App\Enums\StatusEnum::Pending}}" class="flex items-center px-4 py-2 gap-x-2">
            ...
            <li class="hover:bg-gray-100">
                <x-input-label for="status-filter-{{App\Enums\StatusEnum::Approved}}" class="flex items-center px-4 py-2 gap-x-2">
            ...
            <li class="hover:bg-gray-100">
                <x-input-label for="status-filter-{{App\Enums\StatusEnum::Ready}}" class="flex items-center px-4 py-2 gap-x-2">
...
<script type="module">
    $('#reset-filter-button').click(function(e) {
        let form = $("#document-request-search-form");
        form.get(0).reset();
        form.submit();
    });
</script>